...
EXCLUDED_USER_AGENTS_REGEXES = [re.compile(pattern) for pattern in (
    ...
    r'admantx',
    r'alexa',
    r'alexandria(\s|\+)prototype(\s|\+)project',
    r'allentrack',
    r'almaden',
    r'appie',
    r'api[\+\s]scraper',
    ...
    r'checklink',
    r'checkprivacy',
    r'china\slocal\sbrowse\s2\.6',
    r'citoid',
    r'cloakdetect',
    r'coccoc\/1\.0',
    r'code\ssample\sweb\sclient',
    r'coldfusion',
    ...
    r'dsurf',
    r'dts agent',
    r'easybib[\+\s]autocite[\+\s]',
    r'easydl',
    r'ebsco\sejs\scontent\sserver',
    r'ecosearch',
    r'elinks\/',
    r'emailsiphon',
    r'emailwolf',
    r'embedly',
    r'ethos\+\(british\+library\)',
    ...
    r'megite',
    r'metauri[\+\s]api\/\d\.\d',
    r'microsoft(\s|\+)url(\s|\+)control',
    r'microsoft office existence discovery',
    r'microsoft office protocol discovery',
    ...
    r'^mozilla$',
    r'^mozilla.4\.0$',
    r'^mozilla\/4\.0\+\(compatible;\)$',
    r'^mozilla\/4\.0\+\(compatible;\+ics\)$',
    r'^mozilla\/4\.5\+\[en]\+\(win98;\+i\)$',
    r'^mozilla.5\.0$',
    r'^mozilla\/5.0\+\(compatible;\+msie\+6\.0;\+windows\+nt\+5\.0\)$',
    r'^mozilla\/5\.0\+like\+gecko$',
    r'^mozilla\/5.0(\s|\+)gecko\/20100115(\s|\+)firefox\/3.6$',
    r'^msie',
    r'muscatferre',
    r'myweb',
    r'nagios',
...
MATOMO_DEFAULT_MAX_ATTEMPTS = 10
MATOMO_DEFAULT_DELAY_AFTER_FAILURE = 20
...
class Configuration(object):
    ...
    def _parse_args(self, option_parser, argv = None):
        ...
        if self.options.excluded_useragents:
            self.options.excluded_useragents = [re.compile(pattern) for pattern in self.options.excluded_useragents]
