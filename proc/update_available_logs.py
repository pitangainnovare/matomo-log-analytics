...
def main():
    ...
    if 'update_table_log_file' in params.execution_mode:
        ...
        lib_database.update_available_log_files(SESSION_FACTORY(), params.dir_usage_logs, params.collection)

    if 'update_table_date_status' in params.execution_mode:
        logging.info('Updating table date_status')
        lib_database.update_date_status(SESSION_FACTORY(), params.collection)
